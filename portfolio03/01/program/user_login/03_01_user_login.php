<?php
  // phpファイルの読み込み
  require_once('03_01_user_login_class.php');
...
<head>
    ...
    <link rel="stylesheet" href="03_01_user_login.css">
    ...
    <div class="main_wrapper">
      ...
      <div class="main_contents">
        <div class="main_container">
          <!-- 入力フォーム -->
          <form method="post" action="03_01_user_login_check.php">
            <!-- メールアドレスを入力 -->
          ...
          <a href="../user_registeration/03_01_user_registeration.php"><span class="link">※アカウントをお持ちでない場合はこちら</span></a>
          </div>
        </div>
      </div>
      <!-- スタート画面へのリンク -->
